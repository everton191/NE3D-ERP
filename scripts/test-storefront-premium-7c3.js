...
assert(sw.includes("simplifica-3d-v133-visual-blockers-20260531"), "Cache PWA premium ausente");
assert(index.includes("1.0.27-rc-visual-blockers-20260531"), "Cache-bust premium ausente");
