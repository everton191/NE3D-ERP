...
assert(sw.includes("simplifica-3d-v131-design-system-v2-foundation-20260531"), "Cache PWA premium ausente");
assert(index.includes("1.0.25-rc-design-system-v2-foundation-20260531"), "Cache-bust premium ausente");
