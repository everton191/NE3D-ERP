...
assert(sw.includes("simplifica-3d-v153-storefront-idempotency-20260606"), "Cache PWA premium ausente");
assert(index.includes("1.0.47-rc-storefront-idempotency-20260606"), "Cache-bust premium ausente");
