...
assert(sw.includes("simplifica-3d-v170-storefront-icons-20260613"), "Cache PWA premium ausente");
assert(index.includes("1.0.64-storefront-icons-20260613"), "Cache-bust premium ausente");
