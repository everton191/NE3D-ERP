...
assert(sw.includes("simplifica-3d-v142-store-editor-pt-cache-20260603"), "Cache PWA premium ausente");
assert(index.includes("1.0.36-rc-store-editor-pt-cache-20260603"), "Cache-bust premium ausente");
