...
assert(sw.includes("simplifica-3d-v135-storefront-demo-photos-20260601"), "Cache PWA premium ausente");
assert(index.includes("1.0.29-rc-storefront-demo-photos-20260601"), "Cache-bust premium ausente");
