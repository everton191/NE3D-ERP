...
assert(sw.includes("simplifica-3d-v154-storefront-visual-simple-20260606"), "Cache PWA premium ausente");
assert(index.includes("1.0.48-rc-storefront-visual-simple-20260606"), "Cache-bust premium ausente");
