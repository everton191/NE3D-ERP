...
assert(sw.includes("simplifica-3d-v136-storefront-public-ui-20260601"), "Cache PWA premium ausente");
assert(index.includes("1.0.30-rc-storefront-public-ui-20260601"), "Cache-bust premium ausente");
