...
assert(sw.includes("simplifica-3d-v171-storefront-admin-v3-20260613"), "Cache PWA premium ausente");
assert(index.includes("1.0.65-storefront-admin-v3-20260613"), "Cache-bust premium ausente");
