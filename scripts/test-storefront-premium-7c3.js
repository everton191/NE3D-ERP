...
assert(sw.includes("simplifica-3d-v147-app-safe-bottom-20260605"), "Cache PWA premium ausente");
assert(index.includes("1.0.41-rc-app-safe-bottom-20260605"), "Cache-bust premium ausente");
