...
assert(sw.includes("simplifica-3d-v132-erp-shell-v2-20260531"), "Cache PWA premium ausente");
assert(index.includes("1.0.26-rc-erp-shell-v2-20260531"), "Cache-bust premium ausente");
