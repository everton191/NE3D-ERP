...
assert(sw.includes("simplifica-3d-v134-theme-default-light-20260601"), "Cache PWA premium ausente");
assert(index.includes("1.0.28-rc-theme-default-light-20260601"), "Cache-bust premium ausente");
