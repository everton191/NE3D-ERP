...
assert(sw.includes("simplifica-3d-v157-storefront-auto-center-20260607"), "Cache PWA premium ausente");
assert(index.includes("1.0.51-rc-storefront-auto-center-20260607"), "Cache-bust premium ausente");
