...
assert(sw.includes("simplifica-3d-v146-safe-area-android-20260605"), "Cache PWA premium ausente");
assert(index.includes("1.0.40-rc-safe-area-android-20260605"), "Cache-bust premium ausente");
