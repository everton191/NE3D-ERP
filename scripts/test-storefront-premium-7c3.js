...
assert(sw.includes("simplifica-3d-v139-store-light-overflow-20260601"), "Cache PWA premium ausente");
assert(index.includes("1.0.33-rc-store-light-overflow-20260601"), "Cache-bust premium ausente");
