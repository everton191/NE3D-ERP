...
assert(sw.includes("simplifica-3d-v141-light-theme-cleanup-20260602"), "Cache PWA premium ausente");
assert(index.includes("1.0.35-rc-light-theme-cleanup-20260602"), "Cache-bust premium ausente");
