...
assert(index.includes("1.0.51-rc-settings-submenu-align-20260625"), "Cache-bust rebuilt ausente");
assert(sw.includes("simplifica-3d-v193-settings-submenu-align-20260625"), "Cache PWA rebuilt ausente");
