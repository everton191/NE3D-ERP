...
assert(index.includes("1.0.44-rc-mobile-render-stability-20260623"), "Cache-bust rebuilt ausente");
assert(sw.includes("simplifica-3d-v186-mobile-render-stability-20260623"), "Cache PWA rebuilt ausente");
