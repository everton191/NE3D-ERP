...
assert(index.includes("1.0.52-rc-settings-security-menu-20260625"), "Cache-bust rebuilt ausente");
assert(sw.includes("simplifica-3d-v194-settings-security-menu-20260625"), "Cache PWA rebuilt ausente");
