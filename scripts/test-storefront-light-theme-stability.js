...
assert(index.includes("1.0.49-rc-settings-pane-adjacent-20260625"), "Cache-bust rebuilt ausente");
assert(sw.includes("simplifica-3d-v191-settings-pane-adjacent-20260625"), "Cache PWA rebuilt ausente");
