...
assert(index.includes("1.0.54-rc-pwa-motion-smooth-20260626"), "Cache-bust rebuilt ausente");
assert(sw.includes("simplifica-3d-v197-pwa-motion-smooth-20260626"), "Cache PWA rebuilt ausente");
