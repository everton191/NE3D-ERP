...
assert(index.includes("1.0.41-rc-mobile-auth-audit-20260621"), "Cache-bust rebuilt ausente");
assert(sw.includes("simplifica-3d-v181-mobile-auth-audit-20260621"), "Cache PWA rebuilt ausente");
