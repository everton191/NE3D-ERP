...
assert(index.includes("1.0.44-rc-category-images-smart-ranking-release-20260622"), "Cache-bust rebuilt ausente");
assert(sw.includes("simplifica-3d-v185-category-images-smart-ranking-release-20260622"), "Cache PWA rebuilt ausente");
