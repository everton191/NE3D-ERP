...
assert(index.includes("1.0.50-rc-settings-pane-wrapper-20260625"), "Cache-bust rebuilt ausente");
assert(sw.includes("simplifica-3d-v192-settings-pane-wrapper-20260625"), "Cache PWA rebuilt ausente");
