...
assert(sw.includes("simplifica-3d-v134-theme-default-light-20260601"), "Cache PWA da fase 7D.1 nao foi atualizado");
assert(index.includes("1.0.28-rc-theme-default-light-20260601"), "Cache-bust web da fase 7D.1 nao foi atualizado");
