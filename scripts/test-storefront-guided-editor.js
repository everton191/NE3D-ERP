...
assert(sw.includes("simplifica-3d-v145-pwa-apk-nav-adjust-20260604"), "Cache PWA da loja publica nao foi atualizado");
assert(index.includes("1.0.39-rc-pwa-apk-nav-adjust-20260604"), "Cache-bust web da loja publica nao foi atualizado");
[
  "Preview do catálogo",
