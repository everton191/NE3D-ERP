...
assert(sw.includes("simplifica-3d-v149-light-theme-no-gradient-20260606"), "Cache PWA da loja publica nao foi atualizado");
assert(index.includes("1.0.43-rc-light-theme-no-gradient-20260606"), "Cache-bust web da loja publica nao foi atualizado");
[
  "Preview do catálogo",
