...
assert(sw.includes("simplifica-3d-v148-store-safe-area-theme-20260605"), "Cache PWA da loja publica nao foi atualizado");
assert(index.includes("1.0.42-rc-store-safe-area-theme-20260605"), "Cache-bust web da loja publica nao foi atualizado");
[
  "Preview do catálogo",
