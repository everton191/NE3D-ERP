...
assert(sw.includes("simplifica-3d-v157-storefront-auto-center-20260607"), "Cache PWA da loja publica nao foi atualizado");
assert(index.includes("1.0.51-rc-storefront-auto-center-20260607"), "Cache-bust web da loja publica nao foi atualizado");
[
  "Preview do catálogo",
