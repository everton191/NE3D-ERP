...
assert(app.includes("Copiar link da vitrine"), "Toolbar desktop deve nomear claramente a acao de copiar link");
assert(app.includes("Abrir vitrine"), "Toolbar desktop deve nomear claramente a abertura da vitrine");
...
assert(sw.includes("simplifica-3d-v137-light-theme-banner-actions-20260601"), "Cache PWA da loja publica nao foi atualizado");
assert(index.includes("1.0.31-rc-light-theme-banner-actions-20260601"), "Cache-bust web da loja publica nao foi atualizado");
