...
assert(sw.includes("simplifica-3d-v152-storefront-slug-conflict-20260606"), "Cache PWA da loja publica nao foi atualizado");
assert(index.includes("1.0.46-rc-storefront-slug-conflict-20260606"), "Cache-bust web da loja publica nao foi atualizado");
[
  "Preview do catálogo",
