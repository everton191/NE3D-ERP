...
assert(index.includes("1.0.46-rc-storefront-slug-conflict-20260606"), "cache-bust web oficial ausente");
assert(sw.includes("simplifica-3d-v152-storefront-slug-conflict-20260606"), "cache PWA oficial ausente");
