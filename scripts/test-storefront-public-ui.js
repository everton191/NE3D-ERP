...
assert(css.includes("grid-template-columns:112px minmax(0, 1fr) auto;"), "cards administrativos desktop devem ser compactos");
assert(css.includes("grid-template-columns:88px minmax(0, 1fr);"), "cards administrativos mobile devem caber na viewport");
