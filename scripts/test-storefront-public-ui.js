...
assert(index.includes("1.0.47-rc-storefront-idempotency-20260606"), "cache-bust web oficial ausente");
assert(sw.includes("simplifica-3d-v153-storefront-idempotency-20260606"), "cache PWA oficial ausente");
