...
assert(index.includes("1.0.40-rc-safe-area-android-20260605"), "cache-bust web oficial ausente");
assert(sw.includes("simplifica-3d-v146-safe-area-android-20260605"), "cache PWA oficial ausente");
