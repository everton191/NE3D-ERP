...
assert(index.includes("1.0.42-rc-store-safe-area-theme-20260605"), "cache-bust web oficial ausente");
assert(sw.includes("simplifica-3d-v148-store-safe-area-theme-20260605"), "cache PWA oficial ausente");
