...
assert(index.includes("1.0.44-rc-context-menu-contract-20260606"), "cache-bust web oficial ausente");
assert(sw.includes("simplifica-3d-v150-context-menu-contract-20260606"), "cache PWA oficial ausente");
