...
assert(index.includes("1.0.34-rc-store-banner-color-20260602"), "cache-bust web oficial ausente");
assert(sw.includes("simplifica-3d-v140-store-banner-color-20260602"), "cache PWA oficial ausente");
