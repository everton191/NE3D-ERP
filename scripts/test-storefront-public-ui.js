...
assert(index.includes("1.0.52-rc-storefront-contact-actions-20260607"), "cache-bust web oficial ausente");
assert(sw.includes("simplifica-3d-v158-storefront-contact-actions-20260607"), "cache PWA oficial ausente");
