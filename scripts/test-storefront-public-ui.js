...
assert(index.includes("1.0.38-rc-pwa-apk-navigation-20260604"), "cache-bust web oficial ausente");
assert(sw.includes("simplifica-3d-v144-pwa-apk-navigation-20260604"), "cache PWA oficial ausente");
