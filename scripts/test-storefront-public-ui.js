...
assert(index.includes("1.0.45-rc-storefront-persistence-sync-20260606"), "cache-bust web oficial ausente");
assert(sw.includes("simplifica-3d-v151-storefront-persistence-sync-20260606"), "cache PWA oficial ausente");
