...
assert(index.includes("1.0.61-store-v3-theme-isolation-20260612"), "cache-bust web oficial ausente");
assert(sw.includes("simplifica-3d-v167-store-v3-theme-isolation-20260612"), "cache PWA oficial ausente");
