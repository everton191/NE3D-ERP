...
assert(index.includes("1.0.53-rc-auth-gesture-release-20260625"), "Cache-bust web ausente");
assert(sw.includes("simplifica-3d-v195-auth-gesture-release-20260625"), "Cache PWA ausente");
