...
assert(index.includes("1.0.49-rc-storefront-selection-scroll-20260607"), "cache-bust web oficial ausente");
assert(sw.includes("simplifica-3d-v155-storefront-selection-scroll-20260607"), "cache PWA oficial ausente");
