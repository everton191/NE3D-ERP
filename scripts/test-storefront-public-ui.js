...
assert(index.includes("1.0.41-rc-app-safe-bottom-20260605"), "cache-bust web oficial ausente");
assert(sw.includes("simplifica-3d-v147-app-safe-bottom-20260605"), "cache PWA oficial ausente");
