...
assert(index.includes("1.0.55-rc-soft-light-store-20260610"), "cache-bust web oficial ausente");
assert(sw.includes("simplifica-3d-v161-soft-light-store-20260610"), "cache PWA oficial ausente");
