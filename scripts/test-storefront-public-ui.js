...
assert(index.includes("1.0.48-rc-storefront-visual-simple-20260606"), "cache-bust web oficial ausente");
assert(sw.includes("simplifica-3d-v154-storefront-visual-simple-20260606"), "cache PWA oficial ausente");
