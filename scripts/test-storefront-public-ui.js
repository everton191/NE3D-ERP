...
assert(index.includes("1.0.51-rc-storefront-auto-center-20260607"), "cache-bust web oficial ausente");
assert(sw.includes("simplifica-3d-v157-storefront-auto-center-20260607"), "cache PWA oficial ausente");
