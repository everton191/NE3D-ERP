...
assert(index.includes("1.0.43-rc-light-theme-no-gradient-20260606"), "cache-bust web oficial ausente");
assert(sw.includes("simplifica-3d-v149-light-theme-no-gradient-20260606"), "cache PWA oficial ausente");
