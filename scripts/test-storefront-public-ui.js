...
assert(index.includes("1.0.43-rc-security-mobile-release-20260622"), "Cache-bust web ausente");
assert(sw.includes("simplifica-3d-v184-security-mobile-release-20260622"), "Cache PWA ausente");
