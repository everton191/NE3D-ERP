...
assert(index.includes("1.0.39-rc-pwa-apk-nav-adjust-20260604"), "cache-bust web oficial ausente");
assert(sw.includes("simplifica-3d-v145-pwa-apk-nav-adjust-20260604"), "cache PWA oficial ausente");
