...
assert(index.includes("1.0.46-rc-ui-density-motion-20260625"), "Cache-bust web ausente");
assert(sw.includes("simplifica-3d-v188-ui-density-motion-20260625"), "Cache PWA ausente");
