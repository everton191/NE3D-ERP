...
assert(index.includes("1.0.37-rc-storefront-full-test-20260603"), "cache-bust web oficial ausente");
assert(sw.includes("simplifica-3d-v143-storefront-full-test-20260603"), "cache PWA oficial ausente");
