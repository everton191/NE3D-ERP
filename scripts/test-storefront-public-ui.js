...
assert(index.includes("1.0.59-store-v3-examples-20260611"), "cache-bust web oficial ausente");
assert(sw.includes("simplifica-3d-v165-store-v3-examples-20260611"), "cache PWA oficial ausente");
