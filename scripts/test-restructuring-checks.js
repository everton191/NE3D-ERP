...
assert(sw.includes("simplifica-3d-v125-estavel-20260531-percentual-hotfix"), "service worker possui cache versionado atual");
assert(sw.includes("caches.keys()"), "service worker limpa caches antigos");
assert(index.includes("1.0.19-rc-percentual-hotfix-20260531"), "index.html usa cache-bust atual");
[
  "./modules/store-editor/storeEditorRenderer.js",
  "./modules/store-editor/storeEditorTabs.js",
  "./modules/store-editor/storeEditorPreview.js",
