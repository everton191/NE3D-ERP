...
assert(sw.includes("simplifica-3d-v196-store-guided-draft-release-20260626"), "service worker possui cache versionado atual");
...
assert(index.includes("1.0.54-rc-store-guided-draft-release-20260626"), "index.html usa cache-bust atual");
