...
assert(/const APP_VERSION = "1\.0\.33-rc"/.test(app), "app.js esta na versao 1.0.33-rc");
assert(/const APP_VERSION_CODE = 32/.test(app), "app.js possui versionCode 32");
...
assert(sw.includes("simplifica-3d-v170-storefront-icons-20260613"), "service worker possui cache versionado atual");
assert(sw.includes("caches.keys()"), "service worker limpa caches antigos");
assert(index.includes("1.0.64-storefront-icons-20260613"), "index.html usa cache-bust atual");
