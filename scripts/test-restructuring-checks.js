...
assert(sw.includes("simplifica-3d-v139-store-light-overflow-20260601"), "service worker possui cache versionado atual");
assert(sw.includes("caches.keys()"), "service worker limpa caches antigos");
assert(index.includes("1.0.33-rc-store-light-overflow-20260601"), "index.html usa cache-bust atual");
