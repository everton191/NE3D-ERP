...
assert(/const APP_VERSION = "1\.0\.41-rc"/.test(app), "app.js esta na versao 1.0.41-rc");
assert(/const APP_VERSION_CODE = 40/.test(app), "app.js possui versionCode 40");
...
assert(sw.includes("simplifica-3d-v181-mobile-auth-audit-20260621"), "service worker possui cache versionado atual");
assert(sw.includes("caches.keys()"), "service worker limpa caches antigos");
assert(index.includes("1.0.41-rc-mobile-auth-audit-20260621"), "index.html usa cache-bust atual");
