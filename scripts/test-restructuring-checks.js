...
assert(/const APP_VERSION = "1\.0\.0"/.test(app), "app.js esta na versao 1.0.0");
assert(/const APP_VERSION_CODE = 1/.test(app), "app.js possui versionCode 1");
...
assert(/\/app\.js\?v=1\.0\.0-[^"]+/.test(index), "index.html usa cache-bust atual");
