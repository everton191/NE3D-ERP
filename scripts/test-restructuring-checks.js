...
assert(sw.includes("simplifica-3d-v152-storefront-slug-conflict-20260606"), "service worker possui cache versionado atual");
assert(sw.includes("caches.keys()"), "service worker limpa caches antigos");
assert(index.includes("1.0.46-rc-storefront-slug-conflict-20260606"), "index.html usa cache-bust atual");
