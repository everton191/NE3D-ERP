...
assert(/const APP_VERSION = "1\.0\.53-rc"/.test(app), "app.js esta na versao 1.0.53-rc");
assert(/const APP_VERSION_CODE = 52/.test(app), "app.js possui versionCode 52");
...
assert(sw.includes("simplifica-3d-v195-auth-gesture-release-20260625"), "service worker possui cache versionado atual");
...
assert(index.includes("1.0.53-rc-auth-gesture-release-20260625"), "index.html usa cache-bust atual");
