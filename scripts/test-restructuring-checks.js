...
assert(/const APP_VERSION = "1\.0\.39-rc"/.test(app), "app.js esta na versao 1.0.39-rc");
assert(/const APP_VERSION_CODE = 38/.test(app), "app.js possui versionCode 38");
...
assert(sw.includes("simplifica-3d-v179-plans-active-20260618"), "service worker possui cache versionado atual");
