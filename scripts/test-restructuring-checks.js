...
assert(/const APP_VERSION = "1\.0\.43-rc"/.test(app), "app.js esta na versao 1.0.43-rc");
assert(/const APP_VERSION_CODE = 42/.test(app), "app.js possui versionCode 42");
...
assert(sw.includes("simplifica-3d-v184-security-mobile-release-20260622"), "service worker possui cache versionado atual");
...
assert(index.includes("1.0.43-rc-security-mobile-release-20260622"), "index.html usa cache-bust atual");
