...
assert(sw.includes("simplifica-3d-v160-banner-light-20260610"), "service worker possui cache versionado atual");
assert(sw.includes("caches.keys()"), "service worker limpa caches antigos");
assert(index.includes("1.0.54-rc-banner-light-20260610"), "index.html usa cache-bust atual");
