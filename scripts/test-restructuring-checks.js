...
assert(/const APP_VERSION = "1\.0\.3"/.test(app), "app.js esta na versao 1.0.3");
assert(/const APP_VERSION_CODE = 4/.test(app), "app.js possui versionCode 4");
...
assert(/\/app\.js\?v=1\.0\.3-[^"]+/.test(index), "index.html usa cache-bust atual");
