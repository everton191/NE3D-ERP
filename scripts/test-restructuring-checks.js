...
assert(sw.includes("simplifica-3d-v153-storefront-idempotency-20260606"), "service worker possui cache versionado atual");
assert(sw.includes("caches.keys()"), "service worker limpa caches antigos");
assert(index.includes("1.0.47-rc-storefront-idempotency-20260606"), "index.html usa cache-bust atual");
