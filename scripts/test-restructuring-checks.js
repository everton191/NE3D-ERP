...
assert(sw.includes("simplifica-3d-v126-estavel-20260531-store-editor-guided"), "service worker possui cache versionado atual");
assert(sw.includes("caches.keys()"), "service worker limpa caches antigos");
assert(index.includes("1.0.20-rc-store-editor-guided-20260531"), "index.html usa cache-bust atual");
