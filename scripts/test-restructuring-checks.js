...
assert(/const APP_VERSION = "1\.0\.2"/.test(app), "app.js esta na versao 1.0.2");
assert(/const APP_VERSION_CODE = 3/.test(app), "app.js possui versionCode 3");
...
assert(/\/app\.js\?v=1\.0\.2-[^"]+/.test(index), "index.html usa cache-bust atual");
