...
assert(sw.includes("simplifica-3d-v171-storefront-admin-v3-20260613"), "service worker possui cache versionado atual");
assert(sw.includes("caches.keys()"), "service worker limpa caches antigos");
assert(index.includes("1.0.65-storefront-admin-v3-20260613"), "index.html usa cache-bust atual");
