...
assert(sw.includes("simplifica-3d-v149-light-theme-no-gradient-20260606"), "service worker possui cache versionado atual");
assert(sw.includes("caches.keys()"), "service worker limpa caches antigos");
assert(index.includes("1.0.43-rc-light-theme-no-gradient-20260606"), "index.html usa cache-bust atual");
