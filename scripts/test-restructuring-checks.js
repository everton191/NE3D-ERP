...
assert(/const APP_VERSION = "1\.0\.48-rc"/.test(app), "app.js esta na versao 1.0.48-rc");
assert(/const APP_VERSION_CODE = 47/.test(app), "app.js possui versionCode 47");
...
assert(sw.includes("simplifica-3d-v190-settings-pane-fit-20260625"), "service worker possui cache versionado atual");
...
assert(index.includes("1.0.48-rc-settings-pane-fit-20260625"), "index.html usa cache-bust atual");
