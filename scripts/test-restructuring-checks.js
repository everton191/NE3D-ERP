...
assert(sw.includes("simplifica-3d-v137-light-theme-banner-actions-20260601"), "service worker possui cache versionado atual");
assert(sw.includes("caches.keys()"), "service worker limpa caches antigos");
assert(index.includes("1.0.31-rc-light-theme-banner-actions-20260601"), "index.html usa cache-bust atual");
