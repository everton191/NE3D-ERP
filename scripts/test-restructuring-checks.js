...
assert(sw.includes("simplifica-3d-v138-soft-light-no-gradient-20260601"), "service worker possui cache versionado atual");
assert(sw.includes("caches.keys()"), "service worker limpa caches antigos");
assert(index.includes("1.0.32-rc-soft-light-no-gradient-20260601"), "index.html usa cache-bust atual");
