...
assert(/const APP_VERSION = "1\.0\.49-rc"/.test(app), "app.js esta na versao 1.0.49-rc");
assert(/const APP_VERSION_CODE = 48/.test(app), "app.js possui versionCode 48");
...
assert(sw.includes("simplifica-3d-v191-settings-pane-adjacent-20260625"), "service worker possui cache versionado atual");
...
assert(index.includes("1.0.49-rc-settings-pane-adjacent-20260625"), "index.html usa cache-bust atual");
