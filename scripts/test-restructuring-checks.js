...
assert(/const APP_VERSION = "1\.0\.63-rc"/.test(app), "app.js esta na versao 1.0.63-rc");
assert(/const APP_VERSION_CODE = 62/.test(app), "app.js possui versionCode 62");
...
assert(/\/app\.js\?v=1\.0\.63-rc-[^"]+/.test(index), "index.html usa cache-bust atual");
