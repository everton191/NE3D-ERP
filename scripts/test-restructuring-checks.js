...
assert(/const APP_VERSION = "1\.0\.5"/.test(app), "app.js esta na versao 1.0.5");
assert(/const APP_VERSION_CODE = 6/.test(app), "app.js possui versionCode 6");
...
assert(/\/app\.js\?v=1\.0\.5-[^"]+/.test(index), "index.html usa cache-bust atual");
