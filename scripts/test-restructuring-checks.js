...
assert(/const APP_VERSION = "1\.0\.46-rc"/.test(app), "app.js esta na versao 1.0.46-rc");
assert(/const APP_VERSION_CODE = 45/.test(app), "app.js possui versionCode 45");
...
assert(sw.includes("simplifica-3d-v188-ui-density-motion-20260625"), "service worker possui cache versionado atual");
...
assert(index.includes("1.0.46-rc-ui-density-motion-20260625"), "index.html usa cache-bust atual");
