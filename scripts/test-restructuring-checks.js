...
assert(sw.includes("simplifica-3d-v142-store-editor-pt-cache-20260603"), "service worker possui cache versionado atual");
assert(sw.includes("caches.keys()"), "service worker limpa caches antigos");
assert(index.includes("1.0.36-rc-store-editor-pt-cache-20260603"), "index.html usa cache-bust atual");
