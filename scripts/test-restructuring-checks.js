...
assert(/const APP_VERSION = "1\.0\.52-rc"/.test(app), "app.js esta na versao 1.0.52-rc");
assert(/const APP_VERSION_CODE = 51/.test(app), "app.js possui versionCode 51");
...
assert(sw.includes("simplifica-3d-v194-settings-security-menu-20260625"), "service worker possui cache versionado atual");
...
assert(index.includes("1.0.52-rc-settings-security-menu-20260625"), "index.html usa cache-bust atual");
