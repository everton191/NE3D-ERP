...
assert(/const APP_VERSION = "1\.0\.40-rc"/.test(app), "app.js esta na versao 1.0.40-rc");
assert(/const APP_VERSION_CODE = 39/.test(app), "app.js possui versionCode 39");
...
assert(sw.includes("simplifica-3d-v180-storefront-product-data-20260620"), "service worker possui cache versionado atual");
assert(sw.includes("caches.keys()"), "service worker limpa caches antigos");
assert(index.includes("1.0.40-rc-storefront-product-data-20260620"), "index.html usa cache-bust atual");
