...
assert(sw.includes("simplifica-3d-v150-context-menu-contract-20260606"), "service worker possui cache versionado atual");
assert(sw.includes("caches.keys()"), "service worker limpa caches antigos");
assert(index.includes("1.0.44-rc-context-menu-contract-20260606"), "index.html usa cache-bust atual");
