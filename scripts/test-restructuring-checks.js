...
assert(/const APP_VERSION = "1\.0\.42-rc"/.test(app), "app.js esta na versao 1.0.42-rc");
assert(/const APP_VERSION_CODE = 41/.test(app), "app.js possui versionCode 41");
...
assert(sw.includes("simplifica-3d-v183-perceived-performance-android-20260621"), "service worker possui cache versionado atual");
...
assert(index.includes("1.0.42-rc-perceived-performance-android-20260621"), "index.html usa cache-bust atual");
