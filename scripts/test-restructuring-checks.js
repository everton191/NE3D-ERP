...
assert(sw.includes("simplifica-3d-v143-storefront-full-test-20260603"), "service worker possui cache versionado atual");
assert(sw.includes("caches.keys()"), "service worker limpa caches antigos");
assert(index.includes("1.0.37-rc-storefront-full-test-20260603"), "index.html usa cache-bust atual");
