...
assert(/const APP_VERSION = "1\.0\.4"/.test(app), "app.js esta na versao 1.0.4");
assert(/const APP_VERSION_CODE = 5/.test(app), "app.js possui versionCode 5");
...
assert(/\/app\.js\?v=1\.0\.4-[^"]+/.test(index), "index.html usa cache-bust atual");
