...
assert(/const APP_VERSION = "1\.0\.47-rc"/.test(app), "app.js esta na versao 1.0.47-rc");
assert(/const APP_VERSION_CODE = 46/.test(app), "app.js possui versionCode 46");
...
assert(sw.includes("simplifica-3d-v189-pwa-split-pane-20260625"), "service worker possui cache versionado atual");
...
assert(index.includes("1.0.47-rc-pwa-split-pane-20260625"), "index.html usa cache-bust atual");
