...
assert(/const APP_VERSION = "1\.0\.1"/.test(app), "app.js esta na versao 1.0.1");
assert(/const APP_VERSION_CODE = 2/.test(app), "app.js possui versionCode 2");
...
assert(/\/app\.js\?v=1\.0\.1-[^"]+/.test(index), "index.html usa cache-bust atual");
