...
assert(/const APP_VERSION = "1\.0\.30-rc"/.test(app), "app.js esta na versao 1.0.30-rc");
assert(/const APP_VERSION_CODE = 29/.test(app), "app.js possui versionCode 29");
...
assert(sw.includes("simplifica-3d-v167-store-v3-theme-isolation-20260612"), "service worker possui cache versionado atual");
assert(sw.includes("caches.keys()"), "service worker limpa caches antigos");
assert(index.includes("1.0.61-store-v3-theme-isolation-20260612"), "index.html usa cache-bust atual");
