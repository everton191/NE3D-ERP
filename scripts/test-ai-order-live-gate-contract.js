...
assert.match(features, /aiOrderCreateEnabled:\s*false/);
...
console.log("ORDER.CREATE gate: executor legado permanece bloqueado enquanto FunctionGemma opera com WRITE=0.");
