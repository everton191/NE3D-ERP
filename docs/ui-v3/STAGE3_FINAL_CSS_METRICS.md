...
| bytes CSS rastreados | 1.300.612 | 1.281.954 | -18.658 |
| `!important` | 2.236 | 2.098 | -138 |
| `@media` | 192 | 194 | +2 |
...
O CSS copiado pelo build atual soma 1.270.056 bytes em 32 arquivos. Não existe artefato de build preservado do commit baseline; por isso o tamanho comparável antes/depois é o total rastreado acima, e não um bundle antigo inventado.
