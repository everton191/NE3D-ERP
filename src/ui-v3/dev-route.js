(function initUiV3DevRoute(global){
  ...
  function mount(){
    ...
    document.querySelectorAll('link[rel="stylesheet"]:not([href*="/styles/ui-v3/"])').forEach(link=>{if(link instanceof HTMLLinkElement)link.disabled=true});
