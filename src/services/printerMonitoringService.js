(function initPrinterMonitoringService(global) {
  ...
  function errorMessage(code) {
    const messages = {
      ...
      AUTOMATIC_CONNECTOR_REQUIRES_PRO: "Conectores automáticos estão disponíveis no plano Pro.",
      PRINTER_LIMIT_REACHED: "O limite de impressoras do plano foi atingido.",
